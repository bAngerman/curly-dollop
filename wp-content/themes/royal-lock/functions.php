...
if ( ! function_exists( 'royal_lock_setup' ) ) :
	...
	function royal_lock_setup() {
		 ...
		 * If you're building a theme based on royal-lock, use a find and replace
		 * to change 'royal-lock' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'royal-lock', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'main-nav' => esc_html__( 'Primary', 'royal-lock' ),
		) );
